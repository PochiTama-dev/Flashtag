...
const ProductsTable: React.FC = () => {
  ...
  const getIcon = (tipo: string) => {
    switch (tipo) {
      case "Wifi":
        return <FaWifi className="icon-wifi" />;
      case "Link":
        return <FaLink className="icon-link" />;
      case "NFC":
        return <MdNfc className="icon-nfc" />;
      default:
        return null;
    }
  };
    ...
    <div className="products-table">
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "row", gap: "10px" }}>
          <button className="products-buttons-top">
            {" "}
            <IoMdArrowDown className="icon-export" />
            Importar
          </button>
          <button className="products-buttons-top">
            <IoMdArrowUp className="icon-export" /> Exportar
          </button>
        </div>
      </div>
      <div className="table-controls">
        ...
        <button
          ...
          className="products-table-buttons"
        >
        ...
        <button className="products-table-buttons">
          {" "}
          <IoMdArrowUp className="icon-export" /> Exportar
        </button>
        <button
